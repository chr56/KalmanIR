...
class KalmanIRV5(nn.Module):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(KalmanIRV5, self).__init__()
    ...
    def partitioned_parameters(self)-> Dict[str, Iterator[nn.Parameter]]:
        ...
        kalman_parameters = retrieve_partitioned_parameters(self.kalman_refine, "_kalman_refinement")
    ...
    def forward(self, x):
        ...
        binary_refined_2 = self.kalman_refine(
            binary_refined_1, binary_a, binary_b, sigma,
        )
