...
class MultiBranchSRFormerV2(nn.Module):
    """ SRFormer
    ...
    def __init__(self,
                 ...
                 **kwargs):
        from .components_SRFormerV2 import (
            PatchEmbed, PatchUnEmbed, Upsample, UpsampleOneStep,
        )
        from .components_SRFormerV2 import PSA_Group

        super(MultiBranchSRFormerV2, self).__init__()
        num_in_ch = channel
