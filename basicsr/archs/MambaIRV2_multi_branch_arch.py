...
from basicsr.archs.arch_util import init_weights, trunc_normal_
from basicsr.utils.registry import ARCH_REGISTRY


@ARCH_REGISTRY.register()
class MultiBranchMambaIRV2(nn.Module):
    def __init__(self,
                 branch=3,
                 upscale=4,
                 channel=3,
                 ...
                 **kwargs):
        from .components_MambaIRv2 import (
            PatchEmbed, PatchUnEmbed, Upsample, UpsampleOneStep,
        )
        from .components_MambaIRv2 import ASSB
        from .components_MambaIRv2 import window_partition
        ...
        self.window_partition_fn = window_partition
    ...
    def calculate_mask(self, x_size):
        ...
        mask_windows = self.window_partition_fn(img_mask, self.window_size)  # nw, window_size, window_size, 1
