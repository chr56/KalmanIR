...
class MambaITEROCTIRV0_3(nn.Module):
    r""" MambaIR Model
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(MambaITEROCTIRV0_3, self).__init__()
        num_in_ch = in_chans
    ...
    def forward(self, x):
        ...
        #     to_pil = ToPILImage()
        #     L1 = binary_to_decimal(b_L1)
        #     BCE = binary_to_decimal(b_BCE)
        #     p0 = L1[0]
        #     p1 = BCE[0]
        #     plc0 = to_pil(p0)
        #     plc1 = to_pil(p1)
        #     save_directory = "/data1/hsw/results"
        #     save_path = os.path.join(save_directory, f'{formatted_time}L1.png')
        #     save_path1 = os.path.join(save_directory, f'{formatted_time}BCE.png')
        #     plc0.save(save_path)
