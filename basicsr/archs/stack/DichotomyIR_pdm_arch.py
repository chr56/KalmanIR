...
class DichotomyIR_pdm(nn.Module):
    r""" MambaIR Model
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(DichotomyIR_pdm, self).__init__()
        num_in_ch = in_chans
        ...
        self.pd_mamba = SS2D_pd(d_model=embed_dim)
    ...
    def forward(self, x):
        ...
        x_binary_1 = b_BCE #torch.sigmoid(b_BCE)
