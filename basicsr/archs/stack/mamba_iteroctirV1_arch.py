...
class MambaITEROCTIRV1(nn.Module):
    r""" MambaIR Model
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(MambaITEROCTIRV1, self).__init__()
        num_in_ch = in_chans
    ...
    def forward(self, x):
        ...
        x_binary_1 = torch.sin(x)#[bx24xhxw]
        x_decimal_1 = binary_to_decimal(x_binary_1)
        x = self.last_mamba(x_binary_1)
        x_binary_2 = torch.sin(x)
        x_decimal_2 = binary_to_decimal(x_binary_2)
        # x_decimal = binary_to_decimal(x)
        # x = x / self.img_range + self.mean
        return [x_decimal_2, x_decimal_1]
