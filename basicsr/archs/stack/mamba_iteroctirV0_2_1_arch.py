...
class MambaITEROCTIRV0_2_1(nn.Module):
    r""" MambaIR Model
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(MambaITEROCTIRV0_2_1, self).__init__()
        num_in_ch = in_chans
        ...
        #self.conv_first = PConv(num_in_ch, embed_dim, 3, 1)
        ...
        if resi_connection == '1conv':
            ...
            #self.conv_after_body = PConv(embed_dim, embed_dim, 3, 1)
        ...
        if self.upsampler == 'pixelshuffle':
            ...
            #self.conv_last = PConv(num_feat, 2*num_out_ch, 3, 1)
    ...
    def forward(self, x):
        ...
        b_L1 = torch.sin(x[:, :24, ...])#前24个通道做L1 loss
        b_BCE = torch.sin(x[:, 24:, ...])#后24个通道做BCE loss

        x_decimal_1 = binary_to_decimal(b_L1)#[bx3xhxw]
        x_binary_1 = torch.sigmoid(b_BCE)#[bx24xhxw]
...
class Upsample(nn.Sequential):
    ...
    def __init__(self, scale, num_feat):
        ...
        super(Upsample, self).__init__(*m)# Code Implementation of the MambaIR Model