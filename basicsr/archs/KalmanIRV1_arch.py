...
from .kalman.kalman_refine_network_v1 import KalmanRefineNetV1


@ARCH_REGISTRY.register()
class KalmanIRV1(nn.Module):
    r""" MambaIR Model
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(KalmanIRV1, self).__init__()
        # define IR model
        ...
        self.kalman_refine = KalmanRefineNetV1(dim=out_chans)
    ...
    def forward(self, x):
        ...
        refined_zone = self.kalman_refine(
            [binary_b, binary_a, binary_refined],
            factor_dz,
            sigma_t,
        )

        binary_refined = factor_dz * refined_zone + (1 - factor_dz) * binary_refined
